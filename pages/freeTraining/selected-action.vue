	...
	<view class="container">
		...
		<view class="nav-bar">
			<image 
				...
				@click="goBack"
			/>
			<text class="nav-title">已选动作</text>
		...
		<view class="placeholder-area">
			...
			<text class="placeholder-text">已选动作页面开发中...</text>
			<text class="placeholder-count">已接收 {{ selectedActions.length }} 个动作</text>
		</view>
	</view>
</template>
