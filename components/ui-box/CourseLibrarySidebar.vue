		...
		<view class="filter-list">
			...
			<view class="library-switch">
				<view class="library-switch-btn library-switch-btn--active">
					<text class="library-switch-text library-switch-text--active">课程库</text>
				</view>
				<view class="library-switch-btn" @click="handleGoActionLibrary">
					<text class="library-switch-text">动作库</text>
				</view>
			</view>
...
const equipmentOptions = [
	{ value: 'short-bar', label: '短杆' },
	{ value: 'ankle-strap', label: '脚环' },
	{ value: 'triangle-handle', label: '三角把' },
	{ value: 'middle-bar', label: '中杆' },
	{ value: 'yoga-mat', label: '瑜伽垫' },
	{ value: 'lat-bar', label: '横杆' },
	{ value: 'foam-roller', label: '泡沫轴' },
	{ value: 'resistance-band', label: '弹力带' },
	{ value: 'dual-rope', label: '两头绳' },
	{ value: 'fitness-bench', label: '健身椅' }
]
